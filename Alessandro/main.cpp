...
struct PricePoint
{
  std::string date;           ///< Data in formato YYYY-MM-DD
  double      open{};         ///< Prezzo di apertura
  double      high{};         ///< Prezzo massimo
  double      low{};          ///< Prezzo minimo
  double      close{};        ///< Prezzo di chiusura 
  double      adj_close{};    ///< Prezzo di chiusura rettificato
  long        volume{};       ///< Volume degli scambi
};
