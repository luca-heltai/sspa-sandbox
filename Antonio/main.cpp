...
/** Represents a single historical price record.
 *
 * Contains date, open/high/low/close prices,
 * adjusted close, and traded volume.
 */
...
/**
 * @brief Represents the maximum drawdown found in a time series.
 */
 ...
 *
 * The file must contain a header line in Yahoo Finance format:
 * Date,Open,High,Low,Close,Adj Close,Volume
 *
 * @param path Path to the CSV file.
 * @return A vector of PricePoint entries representing the time series.
...
double
/**
 * @brief Computes the arithmetic mean of a vector of values.
 *
 * @param values Vector of double values.
 * @return The mean; returns 0.0 if the vector is empty.
 */
