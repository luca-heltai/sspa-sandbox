...
/** 
 * @brief Singolo record dei prezzi giornalieri estratto dal CSV.
 */
...
/**
 * @brief Rappresenta un drawdown con valore e date di inizio/fine.
 */
struct Drawdown
{
  double      value{};
...
/**
 * @brief Carica i prezzi da un file CSV.
 * @param path Percorso del file CSV.
 * @return std::vector<PricePoint> Lista dei record caricati.
 */
...
/**
 * @brief Calcola la media di un vettore di valori.
 * @param values Serie di valori numerici.
 * @return double Media aritmetica.
 */
double
...
/**
 * @brief Calcola la varianza campionaria dei valori.
 * @param values Serie di valori numerici.
 * @return double Varianza campionaria (N-1).
 */
double
...
/**
 * @brief Calcola il rendimento annualizzato a partire dai rendimenti giornalieri.
 * @param daily Rendimenti giornalieri.
 * @return double Rendimento annualizzato.
 */
double
...
/**
 * @brief Trova il massimo drawdown nella serie dei prezzi.
 * @param prices Serie di PricePoint.
 * @return Drawdown Valore del drawdown e date associate.
 */
Drawdown
...
/**
 * @brief Genera un file di dati compatibile con Gnuplot per prezzi e drawdown.
 * @param prices Serie dei prezzi.
 * @param dd Drawdown massimo calcolato.
 * @param out_path Percorso del file di output.
 */
...
/**
 * @brief Entry point del programma: carica dati, calcola statistiche e genera output.
